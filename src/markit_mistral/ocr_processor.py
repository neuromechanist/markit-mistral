...
class OCRProcessor:
    ...
    def _encode_pdf_to_data_uri(self, pdf_path: Union[str, Path]) -> str:
    ...
    def process_pdf(self, pdf_path: Union[str, Path], include_images: bool = True) -> Dict:
    ...
    def process_image(self, image_path: Union[str, Path], include_images: bool = True) -> Dict:
    ...
    def extract_images(self, response: Dict, output_dir: Union[str, Path]) -> List[Path]:
